  ...
  const initialAnswers = await inquirer.prompt([
    {
      ...
      choices: [
        { name: '📦 Tool - Create a new Vincent tool', value: 'tool' },
...
`;
  ...
  console.log(chalk.gray('2. Create tool: vincent-scaffold add tool my-tool'));
  console.log(chalk.gray('3. Navigate to tool: cd vincent-packages/tools/my-tool'));
